      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs text-muted-foreground">
            <span className="bg-background px-2">oppure registrati con</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 py-2 px-3 rounded-lg border border-border text-sm font-medium hover:bg-muted/50 transition-colors"
          >
