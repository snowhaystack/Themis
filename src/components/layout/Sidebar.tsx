  ...
  return (
    <>
      ...
      >
        ...
        {/* Collapsible panels — History / Pipeline (mutually exclusive) */}
        <div className="flex-1 flex flex-col overflow-hidden pt-2">
          ...
          <div className="flex border-b border-border px-2">
            <button
              ...
              className={`flex-1 px-2 py-2 text-[10px] font-medium uppercase tracking-[0.18em] transition-colors ${
                panel === 'history' ? 'text-accent-hi border-b-2 border-accent' : 'text-muted-2 hover:text-muted'
              }`}
            >
              History
              {sessions.length > 0 && (
                <span className="ml-1.5 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-surface-2 px-1 text-[9px] font-semibold text-muted">
                  {sessions.length}
                </span>
              )}
            </button>
            <button
              ...
              className={`flex-1 px-2 py-2 text-[10px] font-medium uppercase tracking-[0.18em] transition-colors ${
                panel === 'pipeline' ? 'text-accent-hi border-b-2 border-accent' : 'text-muted-2 hover:text-muted'
              }`}
            >
              Pipeline
              {activeAgent != null && (
                <span className="ml-1.5 inline-block h-1.5 w-1.5 rounded-full bg-agent2 animate-pulse" />
              )}
            </button>
          </div>
