    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 sm:grid-cols-2 print:hidden">
        ...
        <div className="card flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted-2">Tree-hours to compensate this report</p>
            ...
            <p className="text-[11px] text-muted">
              of one tree&apos;s CO₂ absorption needed to offset the {analyzer.totals.annualCarbonKg.toFixed(1)} kg CO₂ generated by this report
            </p>
          </div>
        </div>
      </section>
